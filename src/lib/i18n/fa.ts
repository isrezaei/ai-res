export const fa = {
  ...
  projects: {
    ...
    link: "لینک",
    description: "توضیحات",
    namePlaceholder: "مثال: سامانه فروشگاهی",
    rolePlaceholder: "مثال: توسعه‌دهنده ارشد",
    linkPlaceholder: "مثال: github.com/...",
  ...
  certifications: {
    ...
    issuer: "صادرکننده",
    date: "تاریخ",
    namePlaceholder: "مثال: PMP",
    issuerPlaceholder: "مثال: مؤسسه مدیریت پروژه",
    datePlaceholder: "مثال: ۱۴۰۲",
  },
  ...
  design: {
    ...
    colors: "رنگ‌ها",
    customColor: "استفاده از رنگ دلخواه",
    fontStyle: "فونت",
